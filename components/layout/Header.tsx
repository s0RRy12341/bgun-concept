            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {wishlistItems.length > 0 && (
                  <span className="absolute -top-1 -right-1 w-4 h-4 bg-[#b59d5a] text-black text-[10px] font-bold rounded-full flex items-center justify-center">
              ...
              >
                ...
                {totalItems > 0 && (
                  <span className="absolute -top-1 -right-1 w-5 h-5 bg-[#b59d5a] text-black text-[10px] font-bold rounded-full flex items-center justify-center">
                    {totalItems}
                  </span>
                )}
              </button>
