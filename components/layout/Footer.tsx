    ...
    <footer className="bg-[#0A0A0A] border-t border-[#333333] pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-white font-bold text-base mb-4 pb-2 border-b border-[#333333]">
              קישורים מהירים
            </h3>
        ...
        {/* Bottom bar */}
        <div className="border-t border-[#333333] pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[#666666] text-sm text-center sm:text-right">
            © 2026 B-Gun Boutique Holster. כל הזכויות שמורות.
          </p>
          <div className="flex items-center gap-4">
            <span className="text-[#A0A0A0] font-semibold text-sm">Proudly Made In Israel</span>
            <div className="flex items-center gap-2">
              {['VISA', 'MC', 'BIT', 'PAY'].map((p) => (
                <span key={p} className="bg-[#1A1A1A] border border-[#333333] text-[#666666] text-[10px] px-2 py-1 rounded font-mono">
                  {p}
                </span>
              ))}
            </div>
