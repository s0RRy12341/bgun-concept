...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <section className="relative py-24 bg-[#f7f5ee] border-b border-[#e0d9c8] overflow-hidden">
        <div
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-[#b59d5a] font-semibold text-sm tracking-widest uppercase mb-4">מי אנחנו</p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            {/* Text */}
            <div>
              <p className="text-[#b59d5a] font-semibold text-sm tracking-widest uppercase mb-4">הסיפור שלנו</p>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <Link
                  href="/contact"
                  className="border border-[#d4cdb8] hover:border-zinc-400 text-zinc-700 hover:text-black px-6 py-3 rounded-md font-bold transition-colors"
                >
                  דבר איתנו
                </Link>
              </div>
            ...
            <div className="grid grid-cols-2 gap-5">
              {[
                ...
                <div key={i} className="bg-[#f7f5ee] border border-[#e0d9c8] rounded-xl p-6 text-center">
                  <div className="text-3xl mb-2">{stat.icon}</div>
                  <div className="text-[#b59d5a] font-black text-3xl mb-1">{stat.value}</div>
      ...
      {/* Values */}
      <section className="py-20 bg-[#f7f5ee] border-y border-[#e0d9c8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <p className="text-[#b59d5a] font-semibold text-sm tracking-widest uppercase mb-3">הפילוסופיה שלנו</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-white border border-[#e0d9c8] rounded-xl p-6 hover:border-[#b59d5a]/30 transition-all">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <p className="text-[#b59d5a] font-semibold text-sm tracking-widest uppercase mb-3">הדרך שלנו</p>
            ...
            {timeline.map((item, i) => (
              <div key={i} className="flex gap-6">
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 bg-[#b59d5a] rounded-full flex items-center justify-center text-black font-black text-sm flex-shrink-0">
                    {item.year.slice(-2)}
                  </div>
                  {i < timeline.length - 1 && (
                    <div className="flex-1 w-0.5 bg-[#e0d9c8] mt-2" />
                  )}
                </div>
                <div className="pb-8">
                  <div className="text-[#b59d5a] text-sm font-bold mb-1">{item.year}</div>
      ...
      {/* Team */}
      <section className="py-20 bg-[#f7f5ee] border-t border-[#e0d9c8]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-[#b59d5a] font-semibold text-sm tracking-widest uppercase mb-3">האנשים מאחורי המותג</p>
          <h2 className="text-black font-black text-4xl mb-12">הצוות שלנו</h2>

          {team.map((member, i) => (
            <div key={i} className="bg-white border border-[#e0d9c8] rounded-2xl p-10">
              <div className="w-20 h-20 bg-[#e8e4d8] rounded-full flex items-center justify-center text-4xl mx-auto mb-6">
                {member.emoji}
              </div>
              <h3 className="text-black font-black text-2xl mb-1">{member.name}</h3>
              <p className="text-[#b59d5a] font-semibold text-sm mb-6">{member.role}</p>
      ...
      <section className="py-20 bg-[#f7f5ee] border-t border-[#e0d9c8]">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <Link
            href="/collections"
            className="inline-block bg-[#b59d5a] hover:bg-[#c4ad6a] text-black px-8 py-4 rounded-md font-black text-lg transition-all hover:scale-[1.02]"
          >
            לחנות שלנו
          </Link>
        </div>
