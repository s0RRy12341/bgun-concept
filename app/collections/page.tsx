      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-8 pb-6 border-b border-[#333333]">
          ...
          <div className="flex items-center gap-4">
            ...
            <select
              ...
              className="bg-[#1A1A1A] border border-[#333333] text-white text-sm rounded-md px-3 py-2 focus:outline-none focus:border-[#C62828]"
            >
        ...
        <div className="mt-16 bg-[#1A1A1A] border border-[#333333] rounded-xl p-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
            <div>
              <div className="flex justify-center mb-3 text-[#C62828]">
